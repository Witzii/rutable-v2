...
//                RESOURCE.getString("libosm.configsection.GPXFileProvider_filename.desc")));
    ...
    static {
        ...
        /*JMG*/
        Settings.registerPlugin(IVehicle.class, WheelChair.class.getName());
        Settings.registerPlugin(IVehicle.class, Blind.class.getName());
        Settings.registerPlugin(IVehicle.class, Pedestrian.class.getName());
        Settings.registerPlugin(IRoutingMetric.class, PedestrianRouteMetric.class.getName());
        Settings.registerPlugin(IRoutingMetric.class, BlindRouteMetric.class.getName());
        /*JMG*/
