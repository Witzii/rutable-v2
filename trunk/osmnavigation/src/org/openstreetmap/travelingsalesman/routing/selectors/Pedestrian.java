 ...
 */
public final class Pedestrian implements IVehicle {

    /**
     * my logger for debug and error-output.
     */
    private static final Logger LOG = Logger.getLogger(Pedestrian.class.getName());
    ...
    static {
        ...
        ALLOWEDHIGHWAYTYPES.add("pedestrian");
        //ALLOWEDHIGHWAYTYPES.add("elevator");
        ALLOWEDHIGHWAYTYPES.add("steps");
        ALLOWEDHIGHWAYTYPES.add("footway");
        ALLOWEDHIGHWAYTYPES.add("obstacle");
