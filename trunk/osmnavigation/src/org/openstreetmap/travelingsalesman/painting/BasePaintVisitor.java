...
public abstract class BasePaintVisitor implements Visitor, IPaintVisitor {
	...
	/**
	 * Image for the points of the route
	 */
	private BufferedImage imgNeedle = null;
    ...
    //private Style routeStyle = new Style(new Color(127,85,255,Byte.MAX_VALUE), ROUTESEGMENTSTROKEWIDTH);
    /*ADG*/
    /**
    ...
    private Style currentTrackStyle = new Style(new Color(255,0,0,Byte.MAX_VALUE), ROUTESEGMENTSTROKEWIDTH/2);
    /*ADG*/
    ...
    public BasePaintVisitor() {
        super();
        //imgNeedle = ImageIO.read(new File("C:\\needle_left_yellow_2_32.png"));
		imgNeedle = ImageResources.getImage("needle_left_yellow_2_32.png");
    }
...
//        }
    ...
    /*ADG*/
    public void visitPlacesTogo(JList placesToGo) 
    {
        if (placesToGo.getModel().getSize()<=0) {
            return;
        }
        for (int i=0;i<placesToGo.getModel().getSize();i++) 
        {
        	Place place = (Place)placesToGo.getModel().getElementAt(i);
        	Graphics2D g2d = (Graphics2D) g;
        	
        	Point point = this.nc.getPoint(this.nc.getProjection().latlon2eastNorth(place.getLatitude(),place.getLongitude()));
        	
        	g.drawImage(imgNeedle, point.x-18,point.y-29,null);
        }
    }
    /*ADG*/
//    /**
