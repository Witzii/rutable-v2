...
*/
   ...
   public void paintTramStop(final Point centerPoint, final Graphics2D graphicsContext) {
    ...
    public void paintSubwayEntrance(final Point centerPoint, final Graphics2D graphicsContext) {
        BufferedImage img = this.getImage("incomming/london-tube-24.png");
        if (img != null) {
            graphicsContext.drawImage(img, null, centerPoint.x - img.getWidth() / 2, centerPoint.y - img.getHeight() / 2);
        }
    }
    ...
    public void paintAmenity(final Point centerPoint, final String amenityType, final Graphics2D graphicsContext) {
        ...
        /*JMG*/
        else if (amenityType.equals("traffic_signals"))
            img = this.getImage("vehicle/restrictions/traffic-light2.png");
        else if (amenityType.equals("crossing"))
            img = this.getImage("vehicle/zebra_crossing.png");
        else if (amenityType.equals("steps"))
            img = this.getImage("vehicle/restrictions/steps.png");
        else if (amenityType.equals("elevator"))
            img = this.getImage("lift.png");
        else if (amenityType.equals("obstacle"))
            img = this.getImage("vehicle/caution.png");
        /*JMG*/
